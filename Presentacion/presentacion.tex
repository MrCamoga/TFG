...
\begin{frame}
	...
	\begin{definition}
		Se dice que una extensión $\extension {} {\pi} N E Q$ escinde cuando existe un homomorfismo $\homo s Q E$ tal que $\pi \circ s = 1_Q$. % se dice que s es una sección de pi
	\end{definition}

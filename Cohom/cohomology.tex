...
\begin{lema}\label{lem:coborde}
	...
	\begin{demostracion}
		...
		\begin{itemize}
			...
			\item Caso $j=i+1$
				\begin{align*}
					d_{i+1}(d_i(g_0,\ldots,g_{n+3})) 
					&= d_{i+1}(g_0,\ldots,g_ig_{i+1},\ldots,g_{n+3}) \\
					&= (g_0,\ldots,g_ig_{i+1},g_{i+2}g_{i+3},\ldots,g_{n+3}) \\
					&= d_i(g_0,\ldots,g_{i+2}g_{i+3},\ldots,g_{n+3}) \\
					&= d_i(d_{i+2}(g_0,\ldots,g_{n+3}))
				\end{align*}
			\item Caso $j>i+1$
				\begin{align*}

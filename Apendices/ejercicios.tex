% !TeX root=../tfg2.tex
\chapter{Extensiones de $\Z_p$ por $\Z_p$}\label{ZpxZp}


	En este apéndice se calcularán las extensiones salvo equivalencia de $\Z_p$ por $\Z_p$ . % y ver que $H^2(\Z_p,\Z_p) \cong \Z_p$.

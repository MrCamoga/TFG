...
\newcommand{\pretransfer}[2]{\Pletra_{#1/ #2}}
...
% Cohomologia
\input{Cohom/cohomology.tex}

% Extensiones
%\include{Extensiones/sucio.tex}
\input{Extensiones/extensiones.tex}
\input{Extensiones/split.tex}
\input{Extensiones/abelian.tex}
%\input{Extensiones/central.tex}

\input{Hall/hall.tex}
\input{Transfer/transfer.tex}

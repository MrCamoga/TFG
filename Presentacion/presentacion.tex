...
% ACCION DE UNA EXTENSION (SOLO CASO ABELIANO NO JUSTIFICAR LA ACCION EXTERNA BLABLABLA SOLO DECIR QUE i(N) <= Ker(alfa) y por tanto hay una accion  de grupo de Q en A)
...
\begin{frame}
	...
	\begin{definition}
		Se dice que una extensión $\extension {} {\pi} A E Q$ escinde cuando existe un homomorfismo $\homo s Q E$ tal que $\pi \circ s = 1_Q$. % se dice que s es una sección de pi
	\end{definition}
...
\begin{frame}
	...
	\begin{definition}
		Sea $G$ un grupo, $S\leq G$ y $\pi$ un conjunto de primos. Se dice que $S$ es un $\pi$-subgrupo de Sylow cuando es un $\pi$-subgrupo maximal. %Denotamos al conjunto de $\pi$-subgrupos de Sylow como $\Syl \pi G$.
	\end{definition}
	\pause
	\begin{definition}

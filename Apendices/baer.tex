...
\begin{lema}\label{prop:pushout}
	Dada una extensión $\extension i \pi A E Q$ y un homomorfismo de $Q$-módulos $\homo \beta {A} {A'}$, existe una extensión $\extension {} {} {A'} {E_1} Q$ única salvo equivalencia que hace al siguiente diagrama conmutativo.
	...
	\end{tikzcd}\]
	\begin{demostracion}
		Tomamos $E_1=E\sqcup_A A' = \frac{E\ltimes A'}{\{(i(a),-\beta(a))\in E\times A' \ : \ a\in A\}}$ el pushout de $i$ y $\beta$ con la inclusión $i_1$ y proyección $\pi_1$ definidas por
		\begin{gather*}
			i_1(a) = \overline{(1,a)}, \\

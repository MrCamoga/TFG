...
%		vemos que $a$ verifica la ecuación de un $1$-coborde para la función $k\tilde a$ y $H^1(Q,N)$ es trivial. Por el Teorema $\ref{h1}$, todas las escisiones son $N$-conjugadas y por tanto son conjugadas.
		...
		Para la conjugación, cualquier subgrupo $\tilde Q$ de $G$ de orden $m$, al ser $\mcd(n,m)=1$, tiene intersección trivial con $A$ y la proyección sobre $G/A$ es inyectiva. Por tanto, $\tilde Q$ es una escisión de $G$. Por el mismo teorema, $H^1(Q,A)$ es trivial y por el Teorema \ref{h1} todas las escisiones de la extensión $G$ son $A$-conjugadas y por tanto conjugadas. 
	\end{demostracion}
\end{teorema}
